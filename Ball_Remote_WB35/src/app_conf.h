...
#define CFG_BLE_MIN_TX_POWER            (20)			//  Maximum transmit power in dBm supported by the Controller. Range: -127 .. 20
#define CFG_BLE_MAX_TX_POWER            (20)			//  Minimum transmit power in dBm supported by the Controller. Range: -127 .. 20
...
// Maximum supported ATT_MTU size: ignored by the CPU2 when CFG_BLE_OPTIONS is set to 1"
...
//  Source for the low speed clock for RF wake-up:  1 = HSE/32/32;  0 = external low speed crystal (no calibration)
